...
class _SimpleCalculatorState extends State<SimpleCalculator> {
  ...
  buttonPressed(String buttonText) {
    setState(() {
      if (buttonText == "C") {
        ...
        expression = expression.replaceAll('⫪', '3.1415926535897932');
        expression = expression.replaceAll('°', '*(3.1415926535897932/180)');
        expression = expression.replaceAll('e', 'exp');
  ...
  Widget buildButton(
    ...
    return Container(
      margin: new EdgeInsets.fromLTRB(1.0, 1.0, 1.0, 1.0),
